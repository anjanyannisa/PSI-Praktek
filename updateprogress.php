...
<!--       <li class="nav-item">
  ...
  include 'conn.php';
    ...
    $customerexperience = $_POST["customerexperience"];
  	...
  	$hasil = mysqli_query($koneksi,"INSERT INTO tbl_progress (tanggal, jam, NoInet, nama, alamat, CP, keluhan, Jenis_Gangguan, Sub_Gangguan, status, tiket, teknisi, progress, customerexperience)  VALUES ('$tanggal', '$jam', '$NoInet', '$nama', '$alamat', '$CP', '$keluhan', '$Jenis_Gangguan', '$Sub_gangguan', '$status', '$tiket', '$teknisi', '$progress', '$customerexperience')");
