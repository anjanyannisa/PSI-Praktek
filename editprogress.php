    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Memperbarui Data Gangguan Customer setelah dilakukan aksi perbaikan oleh teknisi</p>

             <!-- Card Cari-->
              <div class="card mb-4">
                <div class="card-header">
                  <h5>Update Data Gangguan</h5>
                  <?php
include"conn.php";
...
$nomor = $_GET['NoInet'];
  $query_mysql = mysqli_query($koneksi,"SELECT * FROM tbl_tambahanteknisi WHERE NoInet='$nomor'");
  while($data = mysqli_fetch_array($query_mysql)){
  ?>

    <form from action="updateprogress.php" method="post">
    <table class="table-bordered table-striped">
      ...
      <tr>
        <td>Detail Pogress</td>
        <td><textarea input type="text" name="progress" rows="1" cols="21"></textarea></td>
      </tr>
      <tr>
        <td>Customer Experience</td>
        <td><textarea input type="text" name="customerexperience" rows="1" cols="21"></textarea></td>
      </tr>
      <tr>
